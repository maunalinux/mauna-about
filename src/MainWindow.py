...
class MainWindow:
    ...
    def defineComponents(self):
        ...
        if self.dialog_about.get_titlebar() is None:
            ...
            about_headerbar.pack_start(Gtk.Image.new_from_icon_name("mauna-about", Gtk.IconSize.LARGE_TOOLBAR))
    ...
    def addTurkishFlag(self):
        ...
        pixbuf = GdkPixbuf.PixbufAnimation.new_from_file(os.path.dirname(os.path.abspath(__file__)) + "/../brazil.gif")
